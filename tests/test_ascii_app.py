...
class TestASCIIApp(unittest.TestCase):
    ...
    def test_run_webcam_mode(self, mock_webcam_class) -> None:
        """Проверяет запуск интерактивного режима веб-камеры при передаче соответствующего флага."""
    ...
    def test_run_no_input_and_no_webcam_raises_error(self) -> None:
        """Проверяет аварийное завершение работы, если не переданы ни файл, ни флаг веб-камеры."""
    ...
    def test_run_to_console_success(self) -> None:
        """Проверяет полный цикл обработки изображения и его вывод в консоль."""
    ...
    def test_run_to_file_success(self) -> None:
        """Проверяет успешный экспорт сгенерированного ASCII-арта в выходной текстовый файл."""
