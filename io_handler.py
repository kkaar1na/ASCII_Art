...
class IOHandler:
    ...
    def _setup_arguments(self) -> None:
        ...
        self.parser.add_argument(
            "-o", "--output", help="выходной текстовый файл")
        self.parser.add_argument(
            "-c",
            "--charset",
            default="standard",
        ...
        self.parser.add_argument(
            "--webcam",
            action="store_true",
            help="режим веб-камеры")

    def parse(self) -> argparse.Namespace:
        """Разбирает и возвращает переданные аргументы командной строки.

        Returns:
            Объект Namespace с атрибутами input, output, charset, webcam.
        """
    ...
    def print_to_console(self, ascii_art: str) -> None:
        ...
        Args:
            ascii_art: Многострочная строка с ASCII-артом.
        """
        print(ascii_art)
